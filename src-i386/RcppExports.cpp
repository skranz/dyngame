...
RcppExport SEXP _dyngame_C_get_from_pos(SEXP mSEXP, SEXP pos_kSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _dyngame_C_RowSums_VectorList(SEXP vecSEXP, SEXP ncolsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _dyngame_C_RowMaxs_VectorList(SEXP vecSEXP, SEXP ncolsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type vec(vecSEXP);
...
RcppExport SEXP _dyngame_C_which_RowMaxs_VectorList(SEXP vecSEXP, SEXP ncolsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type vec(vecSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_dyngame_C_get_from_pos", (DL_FUNC) &_dyngame_C_get_from_pos, 2},
    {"_dyngame_C_RowSums_VectorList", (DL_FUNC) &_dyngame_C_RowSums_VectorList, 2},
    {"_dyngame_C_RowMaxs_VectorList", (DL_FUNC) &_dyngame_C_RowMaxs_VectorList, 2},
    {"_dyngame_C_which_RowMaxs_VectorList", (DL_FUNC) &_dyngame_C_which_RowMaxs_VectorList, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_dyngame(DllInfo *dll) {
